...
We currently test Braces against late (usually latest) versions of Python 2.7, 3.4 and 3.5. We also test against the latest released version of Django from 1.5 to 1.10.
